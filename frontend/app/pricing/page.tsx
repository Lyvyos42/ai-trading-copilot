...
const TIERS = [
  {
    name: "Free",
    price: 0,
    description: "Start paper trading with AI signals",
    features: [
      "Paper trading mode",
  ...
  },
  {
    name: "Retail",
    price: 49,
    description: "Full access for individual traders",
    features: [
      "All 80+ strategies",
      "All 8 asset classes",
  ...
  },
  {
    name: "Pro",
    price: 199,
    description: "For professional and semi-pro traders",
    features: [
