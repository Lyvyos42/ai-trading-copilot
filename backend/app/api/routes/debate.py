...
async def trigger_debate(
    ...
    return {
        ...
        "analyst_votes": {
            ...
            "order_flow": state.get("order_flow_analysis", {}).get("direction"),
            "regime_change": state.get("regime_change_analysis", {}).get("direction"),
            "correlation": state.get("correlation_analysis", {}).get("direction"),
        },
        "quant_validated": state.get("quant_validation", {}).get("statistical_edge"),
        ...
        "conviction_tier": state.get("final_signal", {}).get("conviction_tier"),
